        ...
        return (
            <div className={className}>
                ...
                <ul className="list-inline">
                    <li>
                        <DateSelector extractField={extractYear} range={range(field.startYear, field.endYear)} emptyOption="year" onBlur={this.onBlur} onChange={this.onChangeField.bind(this, 'year')} {...field}/>
                    </li>
                    <li>
                        <DateSelector extractField={extractMonth} range={rangeZeroPad(1, 13)} emptyOption="month" onBlur={this.onBlur} onChange={this.onChangeField.bind(this, 'month')} {...field}/>
                    </li>
                    <li>
